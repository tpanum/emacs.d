...
(custom-set-variables
 ...
 '(dashboard-items (quote ((agenda . 10))))
 ...
 '(package-selected-packages
   (quote
    (python-mode dired ob yaml-mode worf with-simulated-input which-key weechat web-mode vue-mode use-package toc-org synosaurus smex smartparens slack rainbow-mode rainbow-delimiters python-black protobuf-mode password-store parinfer ox-spectacle ox-hugo org-ref org-re-reveal org-plus-contrib ob-ipython nlinum nix-mode moody magit lsp-ui langtool kaolin-themes json-mode go-eldoc git-gutter-fringe general flyspell-correct-ivy flycheck-golangci-lint evil-surround evil-snipe evil-nerd-commenter evil-lion evil-indent-plus evil-escape evil-easymotion erc-image erc-hl-nicks doom-themes doom-modeline dockerfile-mode dashboard counsel company-lsp company-go company-box company-auctex circe-notifications cdlatex auctex-latexmk aggressive-indent ace-window)))
